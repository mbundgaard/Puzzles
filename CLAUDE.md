...
When ready to commit and deploy changes, follow these steps:
...
This ensures the app version matches the server version, triggering the update flow for users.
